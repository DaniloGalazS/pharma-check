  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      <div className="text-center">
        <Link href="/" className="text-2xl font-bold text-emerald-600">💊 PharmaCheck</Link>
        <h1 className="mt-4 text-2xl font-bold text-gray-900">Ingresar</h1>
        <p className="mt-1 text-sm text-gray-500">Accede a tus favoritos y alertas de precio</p>
      </div>
